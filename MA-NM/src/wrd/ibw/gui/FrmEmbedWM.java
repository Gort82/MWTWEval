...
public class FrmEmbedWM extends JFrame {
	...
	public FrmEmbedWM(DBConnection pDBConnection) {
		...
		try {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if (returnVal == JFileChooser.APPROVE_OPTION) {
						...
						try {
							...
							imageVector = Util.getImageVector();  
			...
			btnStart.setEnabled(false);
			btnStart.setBounds(512, 138, 89, 23);
			...
			btnExit.setBounds(607, 138, 89, 23);
			...
			txMinLSB.setBounds(87, 50, 26, 20);
