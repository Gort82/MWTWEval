...
public class FrmMain extends JFrame {
	...
	public void getSSIM() {
		try {
			...
			File fileEmb = new File("C://WORKSPACE//2010_SARDROUDI_&_IBRAHIM//img//incrusted.bmp");
			mySSIMCalc = new SsimCalculator(fileEmb);
			
			File fileExt = new File("C://WORKSPACE//2010_SARDROUDI_&_IBRAHIM//img//extracted.bmp");
			
			File fileExt2 = new File("C://WORKSPACE//2010_SARDROUDI_&_IBRAHIM//img//enhanced.bmp");
