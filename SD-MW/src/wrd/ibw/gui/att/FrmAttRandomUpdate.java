...
public class FrmAttRandomUpdate extends JFrame {
	...
	public FrmAttRandomUpdate(DBConnection pDBConnection) {
		...
		btnStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
			    	...
			    	CallableStatement id_inf = dbConnection.getConnection().prepareCall ("{ ? = call GET_RANDOM_IDS (?,?,?)}");
			    	id_inf.registerOutParameter (1, OracleTypes.CURSOR);
			    	id_inf.setString (2,cbTable.getSelectedItem().toString());
			    	id_inf.setString (3,tfPrivateKey.getText());
			    	id_inf.setInt (4, tuplAttack);
			    	id_inf.execute ();
					
				    ResultSet rset_info = (ResultSet)id_inf.getObject (1);
