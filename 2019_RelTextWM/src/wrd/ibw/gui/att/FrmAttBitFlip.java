...
public class FrmAttBitFlip extends JFrame {
	...
	public FrmAttBitFlip(DBConnection pDBConnection) {
		this.dbConnection = pDBConnection;
		try {
		//setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
		this.setComponentOrientation(ComponentOrientation.LEFT_TO_RIGHT);
		this.setTitle("Bit Flipping Attack Simulator...");
		this.setSize(550,411);
		...
		tfFractTupl.setBounds(158, 66, 47, 20);
		...
		panel.setBounds(10, 97, 310, 148);
		getContentPane().add(panel);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 22, 290, 114);
		...
		btnStart.setBounds(403, 254, 122, 23);
		btnStart.addActionListener(new ActionListener() {
			...
			btnExit.setBounds(403, 288, 122, 23);
			...
			panel_5.setBounds(10, 254, 356, 110);
			...
			pnAlgorithms.setBounds(328, 40, 197, 205);
			...
			cbPK.setBounds(10, 34, 114, 23);
			getContentPane().add(cbPK);
			
			JCheckBox cbTF = new JCheckBox("Fraction of Tuples:");
			cbTF.setSelected(true);
			cbTF.setHorizontalAlignment(SwingConstants.RIGHT);
			cbTF.setBounds(10, 65, 149, 23);
